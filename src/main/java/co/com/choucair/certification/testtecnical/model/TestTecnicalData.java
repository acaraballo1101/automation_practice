package co.com.choucair.certification.testtecnical.model;

public class TestTecnicalData {
    ...
    public String getStrPrenda() {
        return strPrenda;
    }

    public void setStrPrenda(String strPrenda) {
